...
ligand_a_atoms = [2035,2036,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2050,2051,2052,2053,2054,2055,2056,2057,2058,2059,2060,2061,2062,2063,2064,2065,2066,2067,2068,2069,2070,2071,2072,2073,2074,2075,2076,2077,2078,2079,2080,2081,2082,2083]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.45758*unit.angstroms
...
harmonicforce.addBond(1634,2049, [bondlength,springconstant])
...
restrainedangle=1.5341*unit.radian
...
angleforce.addAngle(2040,2049,1634, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.62854*unit.radian
angleforce.addAngle(2049,1634,1633, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(2043,2040,2049,1634, [1,-5.66935*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(2040,2049,1634,1633, [1,-3.25304*unit.radian,torsionforceconstant])

torsionforce.addTorsion(2049,1634,1633,1631, [1,-0.00558036*unit.radian,torsionforceconstant])
