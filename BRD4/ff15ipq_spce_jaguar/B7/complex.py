...
forcefield = app.ForceField(proteinXML, waterXML, forcefieldXML, 'input/ligand.xml')
...
ligand_a_atoms = [2035,2036,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2050,2051,2052,2053,2054,2055,2056,2057,2058,2059,2060,2061,2062,2063,2064,2065,2066,2067,2068,2069,2070,2071,2072,2073,2074,2075,2076,2077,2078,2079,2080,2081,2082,2083,2084,2085,2086,2087,2088,2089,2090]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=3.01968*unit.angstroms
...
harmonicforce.addBond(1634,2050, [bondlength,springconstant])
...
restrainedangle=1.7538*unit.radian
...
angleforce.addAngle(2049,2050,1634, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.50216*unit.radian
angleforce.addAngle(2050,1634,1633, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(2064,2049,2050,1634, [1,-0.571228*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(2049,2050,1634,1633, [1,-6.12743*unit.radian,torsionforceconstant])

torsionforce.addTorsion(2050,1634,1633,1631, [1,-0.134193*unit.radian,torsionforceconstant])
...
tmp_dir = './trajectory/'
storage = os.path.join(tmp_dir, 'complex.nc')
...
for i in range(1, iterations_to_analyze+1):
	...
	print("Relative free energy change in {0} = {1} +- {2}"
		.format('complex', Delta_f_ij[0, nstates - 1]*kTtokcal, dDelta_f_ij[0, nstates - 1]*kTtokcal))
