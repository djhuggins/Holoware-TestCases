...
ligand_a_atoms = [2035,2036,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2050,2051,2052,2053,2054,2055,2056]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.87828*unit.angstroms
...
harmonicforce.addBond(1634,2035, [bondlength,springconstant])
...
restrainedangle=1.76629*unit.radian
...
angleforce.addAngle(2037,2035,1634, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.903*unit.radian
angleforce.addAngle(2035,1634,1633, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(2046,2037,2035,1634, [1,-5.66207*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(2037,2035,1634,1633, [1,-3.37944*unit.radian,torsionforceconstant])

torsionforce.addTorsion(2035,1634,1633,1631, [1,-0.0637693*unit.radian,torsionforceconstant])
