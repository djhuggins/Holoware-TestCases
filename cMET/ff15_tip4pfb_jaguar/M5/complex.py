...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762,4763,4764,4765,4766,4767,4768]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.94855*unit.angstroms
...
restrainedangle=1.47898*unit.radian
...
angleforce.addAngle(4748,4724,2683, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.67844*unit.radian
...
torsionforce.addTorsion(4746,4748,4724,2683, [1,-0.279592*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4748,4724,2683,2687, [1,-3.99115*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4724,2683,2687,2685, [1,-5.40555*unit.radian,torsionforceconstant])
