...
bondlength=2.99399*unit.angstroms
...
restrainedangle=1.76921*unit.radian
...
restrainedangle=1.55744*unit.radian
...
torsionforce.addTorsion(4743,4749,4748,1669, [1,-0.380074*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4749,4748,1669,1649, [1,-1.24616*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4748,1669,1649,1651, [1,-6.2751*unit.radian,torsionforceconstant])
