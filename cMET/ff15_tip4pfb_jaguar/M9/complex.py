...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.5456*unit.angstroms
...
harmonicforce.addBond(2683,4738, [bondlength,springconstant])
...
restrainedangle=1.41316*unit.radian
...
angleforce.addAngle(4736,4738,2683, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.6622*unit.radian
angleforce.addAngle(4738,2683,2687, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4749,4736,4738,2683, [1,-0.0500193*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4736,4738,2683,2687, [1,-3.91059*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4738,2683,2687,2685, [1,-5.32487*unit.radian,torsionforceconstant])
