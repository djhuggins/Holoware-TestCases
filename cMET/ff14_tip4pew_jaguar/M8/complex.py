...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762,4763,4764,4765,4766,4767,4768,4769,4770,4771,4772,4773,4774,4775,4776,4777]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.79123*unit.angstroms
...
harmonicforce.addBond(1669,4748, [bondlength,springconstant])
...
restrainedangle=1.65777*unit.radian
...
angleforce.addAngle(4749,4748,1669, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.56676*unit.radian
angleforce.addAngle(4748,1669,1649, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4743,4749,4748,1669, [1,-0.315042*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4749,4748,1669,1649, [1,-1.25142*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4748,1669,1649,1651, [1,-0.102611*unit.radian,torsionforceconstant])
