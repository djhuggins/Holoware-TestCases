...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762,4763,4764,4765,4766,4767]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.06681*unit.angstroms
...
harmonicforce.addBond(1689,4724, [bondlength,springconstant])
...
restrainedangle=1.69757*unit.radian
...
angleforce.addAngle(4723,4724,1689, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.98245*unit.radian
angleforce.addAngle(4724,1689,1708, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4726,4723,4724,1689, [1,-6.11034*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4723,4724,1689,1708, [1,-5.01714*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4724,1689,1708,1687, [1,-5.39511*unit.radian,torsionforceconstant])
