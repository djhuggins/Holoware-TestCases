...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762,4763]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.52094*unit.angstroms
...
harmonicforce.addBond(1669,4732, [bondlength,springconstant])
...
restrainedangle=1.97759*unit.radian
...
angleforce.addAngle(4731,4732,1669, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.53218*unit.radian
angleforce.addAngle(4732,1669,1649, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4728,4731,4732,1669, [1,-0.34885*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4731,4732,1669,1649, [1,-1.21364*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4732,1669,1649,1651, [1,-0.188748*unit.radian,torsionforceconstant])
