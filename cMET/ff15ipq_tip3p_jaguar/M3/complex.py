...
bondlength=2.75813*unit.angstroms
...
harmonicforce.addBond(2454,4748, [bondlength,springconstant])
...
restrainedangle=1.6269*unit.radian
...
angleforce.addAngle(4746,4748,2454, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=2.24615*unit.radian
angleforce.addAngle(4748,2454,2452, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4742,4746,4748,2454, [1,-6.00698*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4746,4748,2454,2452, [1,-2.9659*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4748,2454,2452,2475, [1,-6.11956*unit.radian,torsionforceconstant])
