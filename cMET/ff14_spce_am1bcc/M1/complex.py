...
ligand_a_atoms = [4723,4724,4725,4726,4727,4728,4729,4730,4731,4732,4733,4734,4735,4736,4737,4738,4739,4740,4741,4742,4743,4744,4745,4746,4747,4748,4749,4750,4751,4752,4753,4754,4755,4756,4757,4758,4759,4760,4761,4762,4763,4764,4765,4766]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=2.92904*unit.angstroms
...
harmonicforce.addBond(1669,4728, [bondlength,springconstant])
...
restrainedangle=1.82203*unit.radian
...
angleforce.addAngle(4727,4728,1669, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.61601*unit.radian
angleforce.addAngle(4728,1669,1649, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(4724,4727,4728,1669, [1,-0.228963*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(4727,4728,1669,1649, [1,-1.3296*unit.radian,torsionforceconstant])

torsionforce.addTorsion(4728,1669,1649,1651, [1,-0.00315759*unit.radian,torsionforceconstant])
