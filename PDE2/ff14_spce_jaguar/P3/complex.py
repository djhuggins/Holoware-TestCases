...
ligand_a_atoms = [5332,5333,5334,5335,5336,5337,5338,5339,5340,5341,5342,5343,5344,5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374,5375,5376,5377]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=3.78907*unit.angstroms
...
harmonicforce.addBond(4333,5347, [bondlength,springconstant])
...
restrainedangle=1.75529*unit.radian
...
angleforce.addAngle(5337,5347,4333, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.67816*unit.radian
angleforce.addAngle(5347,4333,4334, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5335,5337,5347,4333, [1,-6.15583*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5337,5347,4333,4334, [1,-3.92081*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5347,4333,4334,4331, [1,-5.52297*unit.radian,torsionforceconstant])
