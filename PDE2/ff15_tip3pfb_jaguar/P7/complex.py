...
harmonicforce.addBond(1016,5348, [bondlength,springconstant])
...
angleforce.addAngle(5349,5348,1016, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.63975*unit.radian
angleforce.addAngle(5348,1016,1014, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5332,5349,5348,1016, [1,-5.61537*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5349,5348,1016,1014, [1,-2.28344*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5348,1016,1014,1013, [1,-1.13331*unit.radian,torsionforceconstant])
