...
harmonicforce.addBond(3548,5332, [bondlength,springconstant])
...
angleforce.addAngle(5336,5332,3548, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.93*unit.radian
angleforce.addAngle(5332,3548,3545, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5345,5336,5332,3548, [1,-0.137117*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5336,5332,3548,3545, [1,-4.31549*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5332,3548,3545,3547, [1,-5.69724*unit.radian,torsionforceconstant])
