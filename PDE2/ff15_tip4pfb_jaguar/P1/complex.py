...
ligand_a_atoms = [5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374,5375,5376,5377,5378,5379,5380,5381,5382,5383,5384,5385,5386,5387]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
harmonicforce.addBond(1035,5361, [bondlength,springconstant])
...
angleforce.addAngle(5362,5361,1035, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.4369*unit.radian
angleforce.addAngle(5361,1035,1034, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5363,5362,5361,1035, [1,-5.95232*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5362,5361,1035,1034, [1,-4.41038*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5361,1035,1034,1031, [1,-6.26332*unit.radian,torsionforceconstant])
