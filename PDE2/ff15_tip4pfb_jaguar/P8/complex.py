...
harmonicforce.addBond(3548,5370, [bondlength,springconstant])
...
angleforce.addAngle(5354,5370,3548, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.93988*unit.radian
angleforce.addAngle(5370,3548,3545, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5362,5354,5370,3548, [1,-0.0944614*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5354,5370,3548,3545, [1,-4.30348*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5370,3548,3545,3547, [1,-5.69933*unit.radian,torsionforceconstant])
