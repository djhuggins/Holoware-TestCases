...
ligand_a_atoms = [5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374,5375,5376,5377,5378,5379,5380,5381,5382,5383,5384,5385,5386,5387,5388,5389,5390,5391,5392,5393,5394,5395,5396,5397,5398,5399,5400,5401,5402,5403,5404]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=3.16359*unit.angstroms
...
harmonicforce.addBond(1814,5374, [bondlength,springconstant])
...
restrainedangle=1.7772*unit.radian
...
angleforce.addAngle(5373,5374,1814, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.7905*unit.radian
angleforce.addAngle(5374,1814,1811, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5372,5373,5374,1814, [1,-5.93873*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5373,5374,1814,1811, [1,-1.97298*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5374,1814,1811,1813, [1,-0.268298*unit.radian,torsionforceconstant])
