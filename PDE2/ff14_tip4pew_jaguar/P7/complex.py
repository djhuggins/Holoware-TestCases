...
ligand_a_atoms = [5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374,5375,5376,5377,5378,5379,5380,5381,5382,5383,5384,5385,5386,5387,5388,5389,5390,5391,5392,5393]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=3.84496*unit.angstroms
...
harmonicforce.addBond(1016,5361, [bondlength,springconstant])
...
restrainedangle=1.40173*unit.radian
...
angleforce.addAngle(5362,5361,1016, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.63975*unit.radian
angleforce.addAngle(5361,1016,1014, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5345,5362,5361,1016, [1,-5.61537*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5362,5361,1016,1014, [1,-2.28344*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5361,1016,1014,1013, [1,-1.13331*unit.radian,torsionforceconstant])
