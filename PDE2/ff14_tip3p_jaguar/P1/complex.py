...
ligand_a_atoms = [5332,5333,5334,5335,5336,5337,5338,5339,5340,5341,5342,5343,5344,5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
bondlength=3.06528*unit.angstroms
...
harmonicforce.addBond(1035,5348, [bondlength,springconstant])
...
restrainedangle=1.63312*unit.radian
...
angleforce.addAngle(5349,5348,1035, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.4369*unit.radian
angleforce.addAngle(5348,1035,1034, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5350,5349,5348,1035, [1,-5.95232*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5349,5348,1035,1034, [1,-4.41038*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5348,1035,1034,1031, [1,-6.26332*unit.radian,torsionforceconstant])
