...
ligand_a_atoms = [5332,5333,5334,5335,5336,5337,5338,5339,5340,5341,5342,5343,5344,5345,5346,5347,5348,5349,5350,5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364,5365,5366,5367,5368,5369,5370,5371,5372,5373,5374,5375,5376,5377,5378,5379,5380,5381]
ligand_a_bonds = []
ligand_a_angles =[]
ligand_a_torsions =[]
...
harmonicforce.addBond(3548,5355, [bondlength,springconstant])
...
angleforce.addAngle(5348,5355,3548, [restrainedangle,angleforceconstant])
angleforce.setForceGroup(new_force_index)

restrainedangle=1.97827*unit.radian
angleforce.addAngle(5355,3548,3547, [restrainedangle,angleforceconstant])
...
torsionforce.addTorsion(5353,5348,5355,3548, [1,-0.708707*unit.radian,torsionforceconstant])
torsionforce.setForceGroup(new_force_index)

torsionforce.addTorsion(5348,5355,3548,3547, [1,-5.16614*unit.radian,torsionforceconstant])

torsionforce.addTorsion(5355,3548,3547,3545, [1,-0.542915*unit.radian,torsionforceconstant])
